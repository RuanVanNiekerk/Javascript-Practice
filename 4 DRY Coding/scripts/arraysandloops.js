//Below you shall find a tasks array which we want to be using for the rest of this challenge
...
function displayArray(arrayName) {
    //Add your code below
    for (i = 0; i < arrayName.length; i++) {                   //Not sure about question?
...
calculateTotal(tasksCompleted);     //argument vs param in this situation?
